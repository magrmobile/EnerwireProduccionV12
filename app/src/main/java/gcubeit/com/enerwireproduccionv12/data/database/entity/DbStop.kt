...
data class DbStop(
    ...
    val meters: Double?,
    val comment: String?,
    @SerializedName("stop_datetime_start")
    val stopDatetimeStart: String,
    @SerializedName("stop_datetime_end")
    val stopDatetimeEnd: String,
...
fun List<DbStop>.asDatabaseModel(): List<Stop> {
    return map {
        Stop (
            id = it.id,
