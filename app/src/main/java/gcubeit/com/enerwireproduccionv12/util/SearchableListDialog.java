...
public class SearchableListDialog extends DialogFragment implements
    ...
    public void setPositiveButon(String strPositiveButtonText, DialogInterface.OnClickListener onClickListener) {
        _strPositiveButtonText = strPositiveButtonText;
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.spinner_item_base, items); // attach the adapter to the list
